<script>
	...
	import escudo from '$lib/img/escudo-actualizado-2022.png';
	
	const desplegar_menu = (e) => {
...
<nav class="bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-600">
	<div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
		<a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
			<img src={logo} class="h-10 logo-img" alt="Flowbite Logo" />
			<header>
				<span class="self-center text-2xl font-semibold whitespace-nowrap text-white">RO-RO</span>
			</header>
		</a>
		<div class="flex md:order-1 space-x-3 md:space-x-0 rtl:space-x-reverse">
			<button
				on:click={desplegar_menu}
				type="button"
			...
			>
				<li>
					<a
						...
						aria-current="page">Acerca de la materia</a
					>
				</li>
				<li>
					<a
...
<footer class="bg-slate-800 p-5">
	<div class="grid grid-cols-1 md:grid-cols-4 gap-5">
		<div class="flex justify-center">
			<img src={escudo} class="w-52" alt="Escudo de la Universidad Autonoma de Baja California" />
		</div>
		<div></div>
		<div></div>
		<div class="flex-col-reverse text-gray-400 h-full p-5">
			<div class="mb-auto">
				<h4 class="font-bold">Trabajo Creado para la materia:</h4>
			...
			<br />
			<br />
			<h4 class="mt-auto font-bold">
				Trabajo creado para la Universidad Autonoma de Baja Califonia.
			</h4>
		</div>
	</div>
</footer>
